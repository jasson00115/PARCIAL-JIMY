...
$route['translate_uri_dashes'] = FALSE;
$route['api'] = 'api/Api';
$route['sesion'] = 'user/Main/sesion';
$route['siguiente'] = 'user/Main/siguiente';
$route['actua'] = 'user/Main/actua';
$route['vistaprin'] = 'user/Main/vistaprin';
$route['vistac'] = 'user/Main/vistac';
